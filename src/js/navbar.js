navbar = 
        '<nav class="navbar navbar-expand-lg navbar-light bg-transparent pt-4 pb-5 ">\
            <div class="container">\
                <a class="navbar-brand" href="index.html">Janice Lin</a>\
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar">\
                    <div class="navbar-nav">\
                        <a class="nav-link" href="index.html" id="menu_work">Work</a>\
                        <a class="nav-link" href="about.html" id="menu_about">About</a>\
                        <a class="nav-link" href="test.pdf" target="_blank" id="menu_resume">Resume</a>\
                    </div>\
                </div>\
            </div>\
        </nav>';
